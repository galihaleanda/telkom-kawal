    ...
    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
        <div class="flex items-center gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Isi semua data di bawah ini untuk membuat akun user.</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <form action="{{ route('users.store') }}" method="POST" id="form-create-user">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                {{-- Jenis Kelamin --}}
                <div class="flex flex-col gap-1.5" x-data="{ selected: '{{ old('jenis_kelamin') }}' }">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <option value="Pria" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('jenis_kelamin') == 'Pria' ? 'selected' : '' }}>Pria</option>
                            <option value="Wanita" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('jenis_kelamin') == 'Wanita' ? 'selected' : '' }}>Wanita</option>
                        </select>
                ...
                {{-- Role --}}
                <div class="flex flex-col gap-1.5" x-data="{ selected: '{{ old('role') }}' }">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <option value="admin" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin</option>
                            <option value="viewer" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" {{ old('role') == 'viewer' ? 'selected' : '' }}>Viewer</option>
                        </select>
                        <span class="pointer-events-none absolute top-1/2 right-3.5 -translate-y-1/2 text-gray-400 dark:text-gray-500">
                            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.792 7.396 10 12.604l5.208-5.208" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                >
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M10 2.5a7.5 7.5 0 1 0 0 15 7.5 7.5 0 0 0 0-15ZM1.25 10a8.75 8.75 0 1 1 17.5 0 8.75 8.75 0 0 1-17.5 0Zm4.375 0a.625.625 0 0 1 .625-.625h3.125V6.25a.625.625 0 1 1 1.25 0v3.125h3.125a.625.625 0 1 1 0 1.25h-3.125v3.125a.625.625 0 1 1-1.25 0v-3.125H6.25a.625.625 0 0 1-.625-.625Z" fill="currentColor"/>
                    </svg>
                    Simpan User
                </button>
            </div>
